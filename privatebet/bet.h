...
struct privatebet_info {
  ...
  bits256 MofN[CARDS777_MAXCARDS * CARDS777_MAXPLAYERS],
      cardpubs[CARDS777_MAXCARDS], playerpubs[CARDS777_MAXPLAYERS + 1], tableid,
      deckid;
...
struct privatebet_vars {
  ...
  uint32_t endround[CARDS777_MAXPLAYERS + 1], evalcrcs[CARDS777_MAXPLAYERS + 1],
      consensus;
  cJSON *actions[CARDS777_MAXROUNDS][CARDS777_MAXPLAYERS + 1];
  int32_t mypermi[CARDS777_MAXCARDS], permi[CARDS777_MAXCARDS], turni, round,
      validperms, roundready, lastround, numconsensus;
