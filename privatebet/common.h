...
extern int32_t all_player_card_matrix[CARDS777_MAXPLAYERS][7]; // where 7 is hand_size
extern int32_t all_player_card_values[CARDS777_MAXPLAYERS][7]; // where 7 is hand_size
